...
![](img/sim_moving_1.gif "Sim detections in action")
...
![](img/site_moving_1.gif "Site detections in action")
...
![](./img/1-sample-original.png "Original")

Only adjusting gamma to 0.5 to improve traffic light visibility on the background

![](./img/2-sample-only-gamma-0.5.png "Gamma adjusted")

Only contrast-adjusting via CLAHE on the L color channel (in LAB color space):

![](./img/3-sample-only-contrast.png "Contrast adjusted")

Adjusting contrast first, gamma second:

![](./img/4-sample-contrast-gamma-0.5.png "Adjusting contrast first, gamma second")

Adjusting gamma first, contrast second:

![](./img/5-sample-gamma-0.5-contrast.png "Adjusting gamma first, contrast second")
